    ...
    <section className="relative min-h-screen flex items-center justify-center pt-20 overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-6 md:px-12 text-center flex flex-col items-center pointer-events-none">
        ...
        >
          <a
            href="#portfolio"
            className="px-8 py-4 bg-white text-black font-bold rounded-full hover:scale-105 transition-transform w-full sm:w-auto"
          >
            Ver Proyectos
          </a>
          <a
            href="#contact"
            className="px-8 py-4 bg-transparent border border-white/20 text-white font-bold rounded-full hover:bg-white/5 transition-colors w-full sm:w-auto"
          >
            Contactar
          </a>
        </motion.div>
